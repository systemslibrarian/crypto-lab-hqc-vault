...
- Do NOT use it for production cryptography. The repository labels itself as illustrative, uses an educational helper path, and does not claim to be a constant-time or standards-conformant HQC deployment.

## Live Demo

**[systemslibrarian.github.io/crypto-lab-hqc-vault](https://systemslibrarian.github.io/crypto-lab-hqc-vault/)**
...
```bash
git clone https://github.com/systemslibrarian/crypto-lab-hqc-vault
cd crypto-lab-hqc-vault
npm install
npm run dev
```
...
- [crypto-lab-kyber-vault](https://systemslibrarian.github.io/crypto-lab-kyber-vault/) — ML-KEM, the lattice-based KEM HQC diversifies against.
- [crypto-lab-bike-vault](https://systemslibrarian.github.io/crypto-lab-bike-vault/) — BIKE, the other code-based (QC-MDPC) post-quantum KEM.
- [crypto-lab-mceliece-gate](https://systemslibrarian.github.io/crypto-lab-mceliece-gate/) — Classic McEliece, the conservative Goppa-code KEM in the same family.
- [crypto-lab-hqc-timing](https://systemslibrarian.github.io/crypto-lab-hqc-timing/) — a timing-oracle attack on HQC's decoder, the implementation-security side of this scheme.
- [crypto-lab-syndrome-drain](https://systemslibrarian.github.io/crypto-lab-syndrome-drain/) — decoding-failure (DOOM) attacks across BIKE, HQC, and Classic McEliece.
